...
def argparser():
    ...
    P.add_argument('--data', type=str, default='datasets/300WLP', help='path to dataset')
    ...
    P.add_argument('--resume', type=str, default='', help='resume from lasteset saved checkpoints', required=False)
    ...
    P.add_argument('--model_size', type=str, default="TINY", choices=['TINY', 'SMALL', 'MEDIUM', 'LARGE'],
                    help="Type of model")
    ...
    P.add_argument('--pretrained', type=str, default='', help='path to model to retrain with')
    ...
    P.add_argument('--overfit-test', action='store_true', help='do overfit test')
    P.add_argument('--InvRes', action='store_true', default=True, help='using inverted residual block from mobilenet-v2')
